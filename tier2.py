# London Calling Tier 2
# Run: python3 tier2.py
...
# See what Unnamed: 37 contains
#Unnamed_37 = properties[properties['London_Borough'] == 'Unnamed: 37']
#print(Unnamed_37.head())

# Filtering the data with NaN values
propertiesD = properties.dropna()
#print(propertiesD.head(48))
